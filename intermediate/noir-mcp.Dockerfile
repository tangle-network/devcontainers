...
# mcp-noir: Needs Noir/Nargo tools
FROM ${REGISTRY}/noir-base:latest

# Copy compiled server
COPY ./dist/index.js /usr/local/bin/noir-mcp-server.mjs
...
CMD ["node", "/usr/local/bin/noir-mcp-server.mjs"]
