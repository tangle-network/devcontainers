...
# mcp-succinct: Needs SP1 + Ethereum tools
FROM ${REGISTRY}/succinct-base:latest

# Copy compiled server
COPY ./dist/index.js /usr/local/bin/succinct-mcp-server.mjs
...
CMD ["node", "/usr/local/bin/succinct-mcp-server.mjs"]
